...
<div id="search">
    ...
    <div class="container search" align="center">
            <form method="GET">&nbsp;&nbsp;<h5>특정날짜선택</h5>&nbsp;&nbsp;
                ...
                <button class="button" type="submit" id="inquiry" />조회</button>
                        ...
                        foreach ($row as $key => $val) {
                            ...
                            if ($key === '승인여부')
                                if ($val === 'N') {
                                    ...
                                    if($_SESSION['Type']==='T'){
                                        $row[$key] = "<a href=make_permit/permission/toggle_permission.php?perm_no=$no_temp&status=cancel><button class='button special'>승인 취소</button></a>\n
                                                      <br id='optimization'/><br id='optimization'/><a href=modify.php><button class='button special'>변경</button></a>\n
                                        ...
                                        $row[$key] = "승인됨&nbsp;&nbsp;<a href=make_permit/permission/outing_permission.php?no=$no_temp><button class='button special'>외출증 출력</button></a>\n";
                                    }
                                }
