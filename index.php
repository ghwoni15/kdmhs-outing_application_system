...
<body>
    ...
    <div id="mNav">
        ...
        <nav id="lnb_d">
            ...
            <?php if($_SESSION['Type']==='S') echo("<a href=\"./apply.phxp\"><button class=\"button special\">외출신청</button></a>"); ?>
    ...
    <div id="welcome">
        ...
        if($_SESSION['User']){
            ...
            echo("환영합니다, ".mysqli_fetch_array($rs,MYSQLI_ASSOC)['Name']."님.");
        }
        ?>
    </div>
    <nav id="lnb">
...
<footer>
    ...
    ⓒCopyright 2016 Korea Digital Media High School.<br/>All rights reserved.<br /><br />System created by J.W.Jeon/T.H.Kim/S.H.Kim HD12.<br/><br />
